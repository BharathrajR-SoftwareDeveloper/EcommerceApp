...
class HomeFragementt : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_home_fragementt, container, false)
    ...
    override fun onViewCreated(view:View,savedInstanceState: Bundle?) {
        ...
        groceryAdapter = GroceryAdapter(listOf(), viewModel)
        rvList.layoutManager = LinearLayoutManager(requireContext())
        rvList.adapter = groceryAdapter

        viewModel.allGroceryItems().observe(viewLifecycleOwner) {
        ...
        btnAdd.setOnClickListener {
            GroceryItemDialog(requireContext(), object : DialogListener {
                override fun onAddButtononClicked(item: GroceryItem) {
